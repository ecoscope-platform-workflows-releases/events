...
from pydantic import BaseModel, ConfigDict, Field, TypeAdapter, confloat, constr
...
class EventsMeshgrid(BaseModel):
    ...
    auto_scale_or_custom_cell_size: (
        ...
        default_factory=lambda: TypeAdapter(
            AutoScaleGridCellSize | CustomGridCellSize
        ).validate_python({"auto_scale_or_custom": "Auto-scale"}),
